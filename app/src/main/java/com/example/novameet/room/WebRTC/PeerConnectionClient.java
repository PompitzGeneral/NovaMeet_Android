...
import static com.example.webrtcmultipleandroidsample.WebRTC.PeerConnectionProperties.AUDIO_AUTO_GAIN_CONTROL_CONSTRAINT;
import static com.example.webrtcmultipleandroidsample.WebRTC.PeerConnectionProperties.AUDIO_CODEC_ISAC;
import static com.example.webrtcmultipleandroidsample.WebRTC.PeerConnectionProperties.AUDIO_CODEC_OPUS;
import static com.example.webrtcmultipleandroidsample.WebRTC.PeerConnectionProperties.AUDIO_CODEC_PARAM_BITRATE;
import static com.example.webrtcmultipleandroidsample.WebRTC.PeerConnectionProperties.AUDIO_ECHO_CANCELLATION_CONSTRAINT;
import static com.example.webrtcmultipleandroidsample.WebRTC.PeerConnectionProperties.AUDIO_HIGH_PASS_FILTER_CONSTRAINT;
import static com.example.webrtcmultipleandroidsample.WebRTC.PeerConnectionProperties.AUDIO_NOISE_SUPPRESSION_CONSTRAINT;
import static com.example.webrtcmultipleandroidsample.WebRTC.PeerConnectionProperties.AUDIO_TRACK_ID;
import static com.example.webrtcmultipleandroidsample.WebRTC.PeerConnectionProperties.VIDEO_CODEC_H264;
import static com.example.webrtcmultipleandroidsample.WebRTC.PeerConnectionProperties.VIDEO_CODEC_H264_BASELINE;
import static com.example.webrtcmultipleandroidsample.WebRTC.PeerConnectionProperties.VIDEO_CODEC_H264_HIGH;
import static com.example.webrtcmultipleandroidsample.WebRTC.PeerConnectionProperties.VIDEO_CODEC_PARAM_START_BITRATE;
import static com.example.webrtcmultipleandroidsample.WebRTC.PeerConnectionProperties.VIDEO_CODEC_VP8;
import static com.example.webrtcmultipleandroidsample.WebRTC.PeerConnectionProperties.VIDEO_CODEC_VP9;
import static com.example.webrtcmultipleandroidsample.WebRTC.PeerConnectionProperties.VIDEO_TRACK_ID;
import static com.example.webrtcmultipleandroidsample.WebRTC.PeerConnectionProperties.VIDEO_TRACK_TYPE;
...
public class PeerConnectionClient {
  ...
  @Nullable
  public String remoteSocketId = null;
  ...
  public PeerConnectionClient(Context appContext,
    ...
    this.isRemoteAudioEnabled = isRemoteAudioEnabled;
  ...
  public void createPeerConnection(final VideoTrack localVideoTrack,
  ...
  public void setIsRemoteVideoEnabled(boolean enabled) {
  ...
  public void setIsRemoteAudioEnabled(boolean enabled) {
  ...
  private void createPeerConnectionInternal() {
    ...
    if (isVideoCallEnabled()) {
      ...
      peerConnection.addTrack(this.localVideoTrack, mediaStreamLabels);
  ...
  public void setAudioEnabled(final boolean enable) {
      isEnableAudio = enable;
      if (localAudioTrack != null) {
        localAudioTrack.setEnabled(isEnableAudio);
      }
  }

  public void setVideoEnabled(final boolean enable) {
      isEnabledVideo = enable;
...
//  }
  ...
  private class PCObserver implements PeerConnection.Observer {
    ...
    public void onIceCandidate(final IceCandidate candidate) {
      executor.execute(() -> events.onIceCandidate(remoteSocketId, candidate));
    }
    ...
    public void onConnectionChange(final PeerConnectionState newState) {
      executor.execute(() -> {
        ...
        if (newState == PeerConnectionState.CONNECTED) {
          events.onConnected(remoteSocketId);
    ...
    public void onAddStream(final MediaStream stream) {
      ...
      try {
        ...
        events.onAddStream(remoteSocketId, remoteVideoTrack);
      } catch (Exception e) {
        e.printStackTrace();
      }
    }
    ...
    public void onSetSuccess() {
        ...
        if (isInitiator) {
          ...
          if (peerConnection.getRemoteDescription() == null) {
            ...
            events.onLocalDescription(remoteSocketId, localDescription);
          } else {
